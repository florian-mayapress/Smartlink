...
?><div class="loop__illu amp-illu" data-color="<?php echo $cat_color; ?>">
    ...
    <a class="illu <?php echo $is_video ? 'is-video-thumb--small':''; ?>" href="<?php the_permalink(); ?>amp">
        <span class="gradient"></span>
        <?php print get_smartlink_thumbnail_amp($post->ID,'maxithumb'); ?>
    </a>
    <span class="cat-wrap">
    <a class="cat" data-background-color="<?php echo $cat_color; ?>" href="<?php echo get_category_link($cat_id) ?>"><?php echo get_cat_name($cat_id); ?></a>
