/*
 * Plugin Name: Slider
 * Version: 1.3.1 Custom (add settings.showNavigation == 'special')
    ...
    (function($, window, document) {
        ...
        var dkJSUSlider = {
            ...
            setElements: function() {
                ...
                // Navigation + pagination special
                if (settings.showNavigation == 'special') {
                    var navigationSpecial = jQuery('<div class="navigation-special"></div>');
                    ...
                    navigationSpecial.append(this.navigation);
                    this.wrapper.append(navigationSpecial);
                    ...
                    this.navigation.append(this.pagination);
